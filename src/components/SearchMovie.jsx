...
<form>   
    <div className="relative">
      <label htmlFor="" className='p text-2xl'>The newest movies available</label>
        <input ref={searchVal} onChange={(e)=>setMessage(e.target.value)} type="search" className="mt-3 block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Search  movie'/>
